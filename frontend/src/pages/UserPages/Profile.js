                                ...
                                bills.map((bill) => (
                                    ...
                                    >
                                        <p className="text-lg font-semibold text-gray-800 mb-2">
                                            <span className="font-bold">Car:</span> {bill.car_rental}
                                        </p>
                                        <p className="text-gray-700">
                                            <span className="font-semibold">Total Amount:</span> ${bill.total_amount}
                                        </p>
                                        <p className="text-gray-700">
                                            <span className="font-semibold">Payment Method:</span> {bill.payment_method}
                                        </p>
                                        <p className="text-gray-700">
                                        ...
                                        {bill.pdf_url ? (
                                            ...
                                            <p className="text-sm text-red-500 mt-2">No PDF available</p>
                                        )}
                                    </div>
                                ))
                            ) : (
